...
namespace Ellis
{
	...
	*************************************************************************/
	...
	struct LRECT {
		MI_INT32 x1, y1, x2, y2;
	};
	enum CalloutLineType : short {
...
namespace EFAL
{
	...
	*/
	...
	EFALFUNCTION Ellis::MICHARSET GetSystemCharset(EFALHANDLE hSession);
	EFALFUNCTION const wchar_t* GetCharsetName(EFALHANDLE hSession, Ellis::MICHARSET charset);
	...
	*/
	...
	EFALFUNCTION EFALHANDLE CoordSysStringToHandle(EFALHANDLE hSession, const wchar_t * csys);
	EFALFUNCTION bool RegisterOGCWKTCoordSysCallbacks(EFALHANDLE hSession, CoordSys_PRJ2OGCWKT_Callback coordSys_PRJ2OGCWKT_Callback, CoordSys_OGCWKT2PRJ_Callback coordSys_OGCWKT2PRJ_Callback);
	EFALFUNCTION bool IsValidCoordSys(EFALHANDLE hSession, const wchar_t * csys);
	EFALFUNCTION EFALHANDLE CreateCoordinateTransform(EFALHANDLE hSession, const wchar_t * csysSource, const wchar_t * csysDest);
	EFALFUNCTION void DestroyCoordinateTransform(EFALHANDLE hSession, EFALHANDLE hCoordinateTransform);
	EFALFUNCTION void DestroyCoordSys(EFALHANDLE hSession, EFALHANDLE hCoordSys);
	EFALFUNCTION Ellis::DPNT TransformCoordinate(EFALHANDLE hSession, EFALHANDLE hCoordinateTransform, Ellis::DPNT src);
	EFALFUNCTION void TransformCoordinates(EFALHANDLE hSession, EFALHANDLE hCoordinateTransform, Ellis::DPNT * src, Ellis::DPNT * dst, MI_UINT32 nPnts);
	EFALFUNCTION Ellis::DRECT TransformRect(EFALHANDLE hSession, EFALHANDLE hCoordinateTransform, Ellis::DRECT src);
	EFALFUNCTION bool ConvertRegistrationPoints2LL(EFALHANDLE hSession, Ellis::DPNT * pWorldDPnt, Ellis::LPNT * pDigLPnt, MI_UINT32 nPnts, const wchar_t * pszCsys);
	EFALFUNCTION double ConvertUnits(EFALHANDLE hSession, double d, Ellis::MIUNIT fromUnit, Ellis::MIUNIT toUnit);

	/* ***********************************************************
	* Geometry Methods
	* ***********************************************************
	*/
	EFALFUNCTION bool GeometryInfo(EFALHANDLE hSession, const wchar_t * varname, int * wkbGeometryType, Ellis::DRECT * mbr, Ellis::DPNT * representativePoint, MI_UINT32 * numberOfParts);
	EFALFUNCTION double GetGeometryLength(EFALHANDLE hSession, const wchar_t * varname, Ellis::MIUNIT unit, Ellis::DIST_CALC_TYPE calcType);
	EFALFUNCTION double GetGeometryPerimeter(EFALHANDLE hSession, const wchar_t * varname, Ellis::MIUNIT unit, Ellis::DIST_CALC_TYPE calcType);
	EFALFUNCTION double GetGeometryArea(EFALHANDLE hSession, const wchar_t * varname, Ellis::MIUNIT unit, Ellis::DIST_CALC_TYPE calcType);

	EFALFUNCTION Ellis::DPNT GetFirstPoint(EFALHANDLE hSession, const wchar_t * varname, const wchar_t * szCSys);
	EFALFUNCTION Ellis::DPNT GetLastPoint(EFALHANDLE hSession, const wchar_t * varname, const wchar_t * szCSys);
	EFALFUNCTION Ellis::DPNT PointAtDistance(EFALHANDLE hSession, const wchar_t * varname, const wchar_t * szCSys, double dDistFromBeginning, Ellis::MIUNIT unit, Ellis::DIST_CALC_TYPE calculationType);
	EFALFUNCTION Ellis::DPNT GetFirstPoint(EFALHANDLE hSession, const wchar_t * varname, EFALHANDLE hCSys);
	EFALFUNCTION Ellis::DPNT GetLastPoint(EFALHANDLE hSession, const wchar_t * varname, EFALHANDLE hCSys);
	EFALFUNCTION Ellis::DPNT PointAtDistance(EFALHANDLE hSession, const wchar_t * varname, EFALHANDLE hCSys, double dDistFromBeginning, Ellis::MIUNIT unit, Ellis::DIST_CALC_TYPE calculationType);
	EFALFUNCTION bool Buffer(EFALHANDLE hSession, const wchar_t * srcvarname, double distance, Ellis::MIUNIT unit, Ellis::DIST_CALC_TYPE calculationType, MI_UINT32 resolution, const wchar_t * dstvarname);
	EFALFUNCTION bool Transform(EFALHANDLE hSession, const wchar_t * srcvarname, const wchar_t * dstvarname, const wchar_t * dstcsys);
	EFALFUNCTION bool Transform(EFALHANDLE hSession, const wchar_t * srcvarname, const wchar_t * dstvarname, EFALHANDLE hDestCSys);
	EFALFUNCTION bool Union(EFALHANDLE hSession, const wchar_t * srcvarname1, const wchar_t * srcvarname2, const wchar_t * dstvarname);
	EFALFUNCTION bool ConvexHull(EFALHANDLE hSession, const wchar_t * srcvarname, const wchar_t * dstvarname);
	EFALFUNCTION bool Intersect(EFALHANDLE hSession, const wchar_t * srcvarname1, const wchar_t * srcvarname2, const wchar_t * dstvarname);
	EFALFUNCTION bool Contains(EFALHANDLE hSession, const wchar_t * srcvarname1, const wchar_t * srcvarname2);
	EFALFUNCTION bool IsWithin(EFALHANDLE hSession, const wchar_t * srcvarname1, const wchar_t * srcvarname2);
	EFALFUNCTION bool Intersects(EFALHANDLE hSession, const wchar_t * srcvarname1, const wchar_t * srcvarname2);
	EFALFUNCTION bool EnvelopesIntersect(EFALHANDLE hSession, const wchar_t * srcvarname1, const wchar_t * srcvarname2);

	EFALFUNCTION bool GeometryInfo(EFALHANDLE hSession, EFALHANDLE hCursor, MI_UINT32 columnNbr, int * wkbGeometryType, Ellis::DRECT * mbr, Ellis::DPNT * representativePoint, MI_UINT32 * numberOfParts);
	EFALFUNCTION double GetGeometryLength(EFALHANDLE hSession, EFALHANDLE hCursor, MI_UINT32 columnNbr, Ellis::MIUNIT unit, Ellis::DIST_CALC_TYPE calcType);
	EFALFUNCTION double GetGeometryPerimeter(EFALHANDLE hSession, EFALHANDLE hCursor, MI_UINT32 columnNbr, Ellis::MIUNIT unit, Ellis::DIST_CALC_TYPE calcType);
	EFALFUNCTION double GetGeometryArea(EFALHANDLE hSession, EFALHANDLE hCursor, MI_UINT32 columnNbr, Ellis::MIUNIT unit, Ellis::DIST_CALC_TYPE calcType);

	EFALFUNCTION Ellis::DPNT GetFirstPoint(EFALHANDLE hSession, EFALHANDLE hCursor, MI_UINT32 columnNbr, const wchar_t * szCSys);
	EFALFUNCTION Ellis::DPNT GetLastPoint(EFALHANDLE hSession, EFALHANDLE hCursor, MI_UINT32 columnNbr, const wchar_t * szCSys);
	EFALFUNCTION Ellis::DPNT PointAtDistance(EFALHANDLE hSession, EFALHANDLE hCursor, MI_UINT32 columnNbr, const wchar_t * szCSys, double dDistFromBeginning, Ellis::MIUNIT unit, Ellis::DIST_CALC_TYPE calculationType);
	EFALFUNCTION Ellis::DPNT GetFirstPoint(EFALHANDLE hSession, EFALHANDLE hCursor, MI_UINT32 columnNbr, EFALHANDLE hCSys);
	EFALFUNCTION Ellis::DPNT GetLastPoint(EFALHANDLE hSession, EFALHANDLE hCursor, MI_UINT32 columnNbr, EFALHANDLE hCSys);
	EFALFUNCTION Ellis::DPNT PointAtDistance(EFALHANDLE hSession, EFALHANDLE hCursor, MI_UINT32 columnNbr, EFALHANDLE hCSys, double dDistFromBeginning, Ellis::MIUNIT unit, Ellis::DIST_CALC_TYPE calculationType);
	EFALFUNCTION bool Buffer(EFALHANDLE hSession, EFALHANDLE hCursor, MI_UINT32 columnNbr, double distance, Ellis::MIUNIT unit, Ellis::DIST_CALC_TYPE calculationType, MI_UINT32 resolution, const wchar_t * dstvarname);
	EFALFUNCTION bool Transform(EFALHANDLE hSession, EFALHANDLE hCursor, MI_UINT32 columnNbr, const wchar_t * dstvarname, const wchar_t * dstcsys);
	EFALFUNCTION bool Transform(EFALHANDLE hSession, EFALHANDLE hCursor, MI_UINT32 columnNbr, const wchar_t * dstvarname, EFALHANDLE hDestCSys);
	EFALFUNCTION bool Union(EFALHANDLE hSession, EFALHANDLE hCursor, MI_UINT32 columnNbr, const wchar_t * srcvarname2, const wchar_t * dstvarname);
	EFALFUNCTION bool ConvexHull(EFALHANDLE hSession, EFALHANDLE hCursor, MI_UINT32 columnNbr, const wchar_t * dstvarname);
	EFALFUNCTION bool Intersect(EFALHANDLE hSession, EFALHANDLE hCursor, MI_UINT32 columnNbr, const wchar_t * srcvarname2, const wchar_t * dstvarname);
	EFALFUNCTION bool Contains(EFALHANDLE hSession, EFALHANDLE hCursor, MI_UINT32 columnNbr, const wchar_t * srcvarname2);
	EFALFUNCTION bool IsWithin(EFALHANDLE hSession, EFALHANDLE hCursor, MI_UINT32 columnNbr, const wchar_t * srcvarname2);
	EFALFUNCTION bool Intersects(EFALHANDLE hSession, EFALHANDLE hCursor, MI_UINT32 columnNbr, const wchar_t * srcvarname2);
	EFALFUNCTION bool EnvelopesIntersect(EFALHANDLE hSession, EFALHANDLE hCursor, MI_UINT32 columnNbr, const wchar_t * srcvarname2);

	/* ***********************************************************
	* String Methods
	* ***********************************************************
	*/
	EFALFUNCTION MI_UINT64 StringByteLength(EFALHANDLE hSession, const wchar_t* pStr, Ellis::MICHARSET charset);
	// Note these functions return pointers to temporary memory. The caller must not delete the returned data.
	// If the returned value is needed to be retained, the caller should make a copy, otherwise it will be potentially
	// overwritten on the next call to EFAL.
	EFALFUNCTION const wchar_t * Utf8String2wchar(EFALHANDLE hSession, const char * pStr);
	EFALFUNCTION const char * WcharString2Utf8(EFALHANDLE hSession, const wchar_t * pStr);

	/* ***********************************************************
	* Utility Methods
	* ***********************************************************
	*/
	EFALFUNCTION void CopyGeometry(EFALHANDLE hSession, EFALHANDLE hCursor, MI_UINT32 columnNbr, const wchar_t * varname);
	EFALFUNCTION void CopyGeometry(EFALHANDLE hSession, const wchar_t * srcvarname, const wchar_t * dstvarname);
	...
	*/
	...
	EFALFUNCTION bool Rewind(EFALHANDLE hSession, EFALHANDLE hCursor);
	...
	*/
	...
	EFALFUNCTION bool SetVariableValueStyleObject(EFALHANDLE hSession, const wchar_t * name, EFALSTYLE value);
	...
	EFALFUNCTION bool SetVariableValueGeometryEx(EFALHANDLE hSession, const wchar_t * name, MI_UINT32 nbytes, const char * value, EFALHANDLE hCoordSys, bool calculateCentroid, bool calculateWithin);
